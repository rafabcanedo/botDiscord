...
const exampleEmbed = new EmbedBuilder()
	.setColor("Blue")
	.setTitle('Comandos Github')
	.addFields(
        { name: '\u200B', value: '\u200B' }, // Line break
		{ name: '$ git init [nome-do-projeto]', value: 'Inicializa o Git no repositório', inline: true },
		...
		{ name: '$ git add .', value: 'Adiciona todos os arquivos na preparação para versionamento', inline: true },
		{ name: '$ git commit -m "[mensagem]"', value: 'Nomeia o commit no histórico de versão', inline: true },
		{ name: '\u200B', value: '\u200B' },
...
module.exports = {
 ...
 .setName("git")
 .setDescription("Lista de todos os comandos Git que uso diariamente"),
